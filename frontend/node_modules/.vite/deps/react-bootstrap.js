  ...
  return function createPopper3(reference2, popper2, options2) {
    ...
    function runModifierEffects() {
      state.orderedModifiers.forEach(function(_ref) {
        var name = _ref.name, _ref$options = _ref.options, options3 = _ref$options === void 0 ? {} : _ref$options, effect3 = _ref.effect;
...
function useDropdownMenu(options2 = {}) {
  ...
  const show = (context6 == null ? void 0 : context6.show) == null ? !!options2.show : context6.show;
...
var NavItem = React88.forwardRef((_ref, ref) => {
  let {
    ...
    active,
    eventKey
  } = _ref, options2 = _objectWithoutPropertiesLoose7(_ref, _excluded6);
  const [props, meta] = useNavItem(Object.assign({
    key: makeEventKey(eventKey, options2.href),
    active
  }, options2));
  props[dataAttr("active")] = meta.isActive;
  return (0, import_jsx_runtime79.jsx)(Component2, Object.assign({}, options2, props, {
    ref
  }));
});
